function Play()
    Div(:class => "space-y-8",
        ...
        Div(:class => "a-card bg-base-100 rounded-box overflow-hidden",
            RawHtml("""<iframe src="https://snapshot.djblack.workers.dev/app/Dale-Black/snapshot-demo/snapshot-demo/demo/demo.html" title="Live notebook" style="width:100%;height:540px;border:0;display:block"></iframe>""")),
